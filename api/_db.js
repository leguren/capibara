 ...
 *
 * El schema está embebido directamente en este archivo (no se lee desde disco)
 * porque Vercel serverless no garantiza acceso al filesystem en runtime.
 */

const { getDb } = require('./_turso');

// ---------------------------------------------------------------------------
// Schema embebido — mismo contenido que migrations/001_initial.sql
// ---------------------------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS sources (
  ...
  access_method     TEXT NOT NULL DEFAULT 'url',
...
async function initSchema() {
  ...
  // Ejecutar cada statement por separado (Turso no soporta múltiples en uno)
